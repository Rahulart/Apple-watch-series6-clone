! function t(e, n, o) {
            ...
            d = (t(21), {
                initialize: function() {
                    ...
                    return o.addTests({
                        ...
                        ios14: r.os.ios && r.os.version.major >= 14,
                        iphone: function() {
                            let t = window.navigator.userAgent.match(/iPhone/g);
                        ...
                        "enhanced-layout": !c && !r.browser.ie && !r.browser.edge && !t || n && !t,
                        "static-layout": r.browser.ie || r.browser.edge || t || r.browser.android || c,
                        "ac-nav-overlap": !0,
                        "quick-look": d(),
                        "modern-ar": !(r.os.ios && 12 == r.os.version.major) && d(),
                        "classic-ar": r.os.ios && 12 == r.os.version.major && d(),
                        ecg: !0
                    }), o.htmlClass(), this
                }
            });
    ...
    21: [function(t, e, n) {
        "use strict";
        const o = function(t) {
            for (var e = {}, n = t.substr(1).split("&"), o = 0; o < n.length; o++)
                if (0 !== n[o].length) {
                    var r = n[o].split("=");
